...
class BeerBrand(models.Model):
    ...
    brand_logo = models.ImageField(upload_to="brands", blank=True)
...
class Vendor(models.Model):
    ...
    vendor_logo = models.ImageField(upload_to="vendors", blank=True)
...
class Beer(models.Model):
    ...
    note = models.CharField(max_length=15, default="", blank=True)
